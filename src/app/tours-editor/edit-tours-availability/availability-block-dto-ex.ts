...
import { AvailabilityBlockDto, IAvailabilityBlockDto, TourTypesEnum } from "@shared/service-proxies/service-proxies";
import { DateObjectUnits, DateTime } from "luxon";

/**
 * Extends AvailabilityBlockDto for UI purposes
 */
export class AvailabilityBlockDtoEx extends AvailabilityBlockDto {

    selected = true;

    constructor(data?: Partial<AvailabilityBlockDtoEx> & IAvailabilityBlockDto) {
        super(data);
    }

    get duration() {
        return this.endTime.diff(this.startTime, 'minutes').minutes
    }
    ...
    hasTourType(tourType: TourTypesEnum): boolean {
