...
import { WidgetTopToolsAndResourcesComponent } from './widgets/widget-top-tools-and-resources/widget-top-tools-and-resources.component';
import { WidgetYourInsightsComponent } from './widgets/widget-your-insights/widget-your-insights.component';
import { WidgetsMarketingToolsComponent } from './widget-marketing-tools/widget-marketing-tools.component';
...
export class DashboardViewConfigurationService {
    ...
    private initializeConfiguration() {
        ...
        let topTools = new WidgetViewDefinition(
            DashboardCustomizationConst.widgets.tenant.topTools,
        ...
        let yourInsights = new WidgetViewDefinition(
            DashboardCustomizationConst.widgets.tenant.yourInsights,
            WidgetYourInsightsComponent
        );

        let marketingTools = new WidgetViewDefinition(
            DashboardCustomizationConst.widgets.tenant.marketingTools,
        ...
        this.WidgetViewDefinitions.push(topTools);
        this.WidgetViewDefinitions.push(yourInsights);
        this.WidgetViewDefinitions.push(marketingTools);
    }
}
